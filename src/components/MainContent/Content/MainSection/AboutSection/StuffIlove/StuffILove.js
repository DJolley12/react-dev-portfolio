...
function StuffILove() {
    ...
    return (
        <>
            ...
            {displayLiveServer && <p className="main_text_color stuff_paragraph" style={paragraphStyle}>While creating static HTML, there is nothing better in my opinion than this add-on. It is a lot like the Brackets editor, where it allows auto refresh on save, so you don't need to refresh to display the changes you are making. It also allows you to easily display individual pages while creating them.</p>}
