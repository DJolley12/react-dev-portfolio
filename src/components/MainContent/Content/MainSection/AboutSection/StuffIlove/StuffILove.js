...
function StuffILove() {
    ...
    return (
        <>
            ...
            {displayCyberpunkTheme && <p className="main_text_color" style={paragraphStyle}>This theme gets me in the mood to write code, and I find myself more likely to stay up working because of it. I could stare at this theme for hours. It is so visually pleasing to me, that it actually makes me want to write more code, and I find myself sometimes using VS Code simply so I can have the theme. That said, it also has a lot of advantages, such as a high variety in it's color palette, making it easier to instantly recognize elements in code. It also has a brighter color for bracket section highlighting, which makes me get lost less easy. <br></br>Overall, the theme is easy on the eyes, but not so dark that it has too much contrast. This is my favorite theme I've found so far. Check it out  <a href="https://marketplace.visualstudio.com/items?itemName=max-SS.cyberpunk" className="secondary_button flicker link_tag"><u>here</u></a></p>}
            {displaySynthwave84Theme && <p className="main_text_color" style={paragraphStyle}>Enable Neon Dreams: enough said. This theme has an awesome glow to some of the elements with this enabled. It looks awesome, I highly recommend you check it out! The Visual Studio Marketplace has a description on how to enable neon dreams, check it out <a href="https://marketplace.visualstudio.com/items?itemName=RobbOwen.synthwave-vscode" className="secondary_button flicker link_tag"><u>here</u></a></p>}
            ...
            {displayMaterialThemeIcons && <p className="main_text_color" style={paragraphStyle}>This one is simple: I just like it. Ha.<br></br> These make it easier to not get lost in folders and folders and moar code and moar code. Directories look pleasing, and they are much easier to navigate your projects.</p>}
            {displayPackageManagers && <p className="main_text_color" style={paragraphStyle}>Long gone are the days of manually adding dependencies, but I'm continually reminded everytime i use a package manager how easy it now is to simply install a package, i.e. npm install -package name-. The fact this downloads all the dependecies on that package, and puts it easily into your project, without needing a browser to go online, find the download, etc., etc. is just awesome. You can't survive in our world without these anymore, seeing as so many projects are dependent on sometimes thousands of other packages.</p>}
            {displaySpotify && <p className="main_text_color" style={paragraphStyle}>I love music. I'm a musician, but listening to music can help focus, and create a state of flow. Check out my main flow playlist <a href="https://open.spotify.com/playlist/4O0Eeozj7U0t2fLo7iPVMv?si=rUx5xBcPR12elc2-bp-1qg"><u>here</u></a>.</p>}
            {displayEZBlocker && <p className="main_text_color" style={paragraphStyle}>Nothing interrupts flow like obnoxious, repetative ads, with horrible jingles that get stuck in your head, and when I finally had enough of ads that almost seem to taunt you into paying for premium spotify membership, I had enough, and found this on GitHub, which has improved my happiness through my workdays. You can find it <a href="https://github.com/Xeroday/Spotify-Ad-Blocker" className="secondary_button flicker link_tag"><u>here</u></a>.</p>}
        </>
    )
}
