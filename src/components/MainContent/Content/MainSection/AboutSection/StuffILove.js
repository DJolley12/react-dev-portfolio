...
function StuffILove() {
    ...
    return (
        <>
            ...
            {displayEZBlocker && <p className="main_text_color" style={paragraphStyle}>Nothing interrupts flow like obnoxious, repetative ads, with horrible jingles that get stuck in your head, and when I finally had enough of ads that almost seem to taunt you into paying for premium spotify membership, I had enough, and found this on GitHub, which has improved my happiness through my workdays. You can find it <a href="https://github.com/Xeroday/Spotify-Ad-Blocker"><u>here</u></a>.</p>}
        </>
    )
}
